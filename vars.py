...
# API Configuration
API_ID = int(os.environ.get("API_ID", "25198075"))
API_HASH = os.environ.get("API_HASH", "017d85942bb4ae3b895b6d52a052ee13")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8010665948:AAEM2Z0WBt38BDg7zzuT1RnsIzRaiIcgVHs")
...
OWNER_ID = int(os.environ.get("OWNER_ID", "6166894330"))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "6166894330").split()]  # Default to owner ID
